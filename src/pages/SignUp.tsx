...
import { Eye, EyeOff, Music, Mail, User, Lock } from "lucide-react";
        ...
        <div className="max-w-md mx-auto">
          <Card className="neon-glow-blue border-primary/20 bg-card/50 backdrop-blur-lg">
            <CardHeader className="text-center space-y-4">
              ...
              <div>
                <CardTitle className="text-2xl font-orbitron gradient-text">Join JEE BEATZ</CardTitle>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  <Link to="/login" className="text-primary hover:text-primary/80 font-medium hover-glow-blue">
                    Sign in
                  </Link>
                </p>
              </div>
